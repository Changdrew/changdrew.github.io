$(document).ready(function() {
	var fourteen_east = ["IND", "MIA", "TOR", "CHI", "WAS", "BRK", "CHA", "ATL", "NYK", "CLE", "DET", "BOS", "ORL", "PHI", "MIL"];
	var fourteen_west = ["SAS", "OKC", "LAC", "HOU", "POR", "GSW", "MEM", "DAL", "PHO", "MIN", "DEN", "NOP", "SAC", "LAL", "UTA"];
	var fourteen_champs = "SAS"
	var thirteen_east = ["MIA", "NYK", "IND", "BRK", "CHI", "ATL", "BOS", "MIL", "PHI", "TOR", "DET", "WAS", "CLE", "CHA", "ORL"]
